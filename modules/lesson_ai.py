def generate_lesson_plan_ai(api_key, raw_text, metadata, competency_framework):
    ...
    # Sử dụng dấu nháy kép chuẩn tiêu chuẩn JSON bên trong prompt
    system_prompt = """Bạn là chuyên gia thiết kế bài dạy cao cấp theo CTGDPT 2018 và Công văn 5512 của Bộ Giáo dục Việt Nam.
